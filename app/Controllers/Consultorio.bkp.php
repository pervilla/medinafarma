...
class Consultorio extends BaseController {
    ...
    public function index() {
        ...
        $campania = $this->CampaniaModel->get_campanias();
        $this->MedioModel = new MedioModel();
        $medios = $this->MedioModel->get_medios();        
    ...
    public function todos() {
        ...
        $CIT_CODCAMP = $this->request->uri->getSegment(3);
        $this->CampaniaModel = new CampaniaModel();
        $campania = $this->CampaniaModel->get_campanias(null,1);
        $this->MedioModel = new MedioModel();
        $medios = $this->MedioModel->get_medios();
        $data['campanias_cod'] = $CIT_CODCAMP;
        $data['campanias'] = $campania;
    ...
    public function confirmados() {
        ...
        $this->CampaniaModel = new CampaniaModel();
        $campania = $this->CampaniaModel->get_campanias($CIT_CODCAMP);
        $data['campanias'] = $campania;
    ...
    public function campania(){
        $this->CampaniaModel = new CampaniaModel();
        $campania = $this->CampaniaModel->get_campanias(null,'todos');
        $this->ClientesModel = new ClientesModel();
        $medicos = $this->ClientesModel->get_personas('','25','M','');
    ...
    public function atencion(){
        ...
        $this->ClientesModel = new ClientesModel();
        $clientes = $this->ClientesModel->get_personas($CIT_CODCLIE,'25','','');       
        $this->HistoriaModel = new HistoriaModel();
        a:
        $nrohist = $this->HistoriaModel->get_nro_historia($CIT_CODCIT,$CIT_CODCLIE,$CIT_CODCAMP);
        if($nrohist){
            $historia = $this->HistoriaModel->get_historia($nrohist);
        }else{
            $data = array('HIS_CODCIT' => $CIT_CODCIT,'HIS_CODCLI' => $CIT_CODCLIE,'HIS_CODCAMP' => $CIT_CODCAMP); 
            $this->HistoriaModel->set_historia($data);
            goto a;
        }
        
        $historias = $this->HistoriaModel->get_historias($CIT_CODCLIE);
    ...
    public function historia(){
        ...
        $nrohist = $this->HistoriaModel->get_nro_historia($CIT_CODCIT,$CIT_CODCLIE,$CIT_CODCAMP);
        $historia = $this->HistoriaModel->get_historia($nrohist);
        $diagnost = $this->HistoriaModel->get_historia_diag($nrohist);        
        $receta = $this->HistoriaModel->get_historia_receta($nrohist);
        $data['clientes'] = $clientes[0];
        $data['historia'] = $historia[0];        
    ...
    public function actualiza_historia(){
        ...
        if($this->request->getVar('TRIAJE')=='si'){
            ...
            $orden = $this->CitasModel->get_orden_atencion($CODCAM,$CODCIT);
            if($orden->ORD==0){$this->CitasModel->set_orden_atencion($CODCIT,$orden->CIT_ORD_ATENCION);}
        }
        $data = array();
        ...
        $this->HistoriaModel = new HistoriaModel();
       $upd = $this->HistoriaModel->upd_historia($CODHIS,$data); 
    ...
    public function get_cie_nombre() {
        ...
        $this->HistoriaModel = new HistoriaModel();
        $desc = $this->HistoriaModel->get_cie_descripcion($cie,$dsc);
    ...
    public function delete_cie(){
        ...
        $cie = $this->request->getVar('cie');
        $this->HistoriaModel = new HistoriaModel();
        $desc = $this->HistoriaModel->delete_cie($his,$cie);
        return$this->response->setJSON($desc);
    }
    /********************
     *** DIAGNOSTICO ****
    ...
    public function guarda_diagnostico(){
        ...
        $this->HistoriaModel = new HistoriaModel();
        $desc = $this->HistoriaModel->set_historia_diag($data);
        return $desc;
    }
    public function actualiza_diagnostico(){
        ...
        $this->HistoriaModel = new HistoriaModel();
        $desc = $this->HistoriaModel->upd_historia_diag($his,$b,$data);
    }
    public function get_diagnostico(){
        $his = $this->request->getVar('his');
        $this->HistoriaModel = new HistoriaModel();
        $desc = $this->HistoriaModel->get_historia_diag($his);
    ...
    public function guarda_receta(){
        ...
        if($this->request->getVar('upd')==0){
            $this->HistoriaModel = new HistoriaModel();
            $desc = $this->HistoriaModel->set_historia_receta($data);
        }elseif($this->request->getVar('upd')==1){
            $this->HistoriaModel = new HistoriaModel();
            $desc = $this->HistoriaModel->upd_historia_receta($data);
        }
    ...
    public function get_receta(){
        $his = $this->request->getVar('his');
        $this->HistoriaModel = new HistoriaModel();
        $desc = $this->HistoriaModel->get_historia_receta($his);
        return$this->response->setJSON($desc);
    }
    public function delete_receta(){
        ...
        $this->HistoriaModel = new HistoriaModel();
        $desc = $this->HistoriaModel->delete_historia_receta($his,$car);
        return$this->response->setJSON($desc);
    }
    ...
    public function get_citas() {
        ...
        $this->CitasModel = new CitasModel();
        $citas = $this->CitasModel->get_citas($camp,$esta);
        //var_export($operaciones);
    ...
    public function get_orden(){
        $camp = $this->request->getVar('camp');    
        $this->CitasModel = new CitasModel();
        $orden = $this->CitasModel->get_orden($camp);
        $orden = $orden?$orden:1;    
    ...
    public function get_monto(){
        ...
        $monto = $this->Server03Model->get_monto($serie,$numer);        
        echo 'S/. '.$monto;
    }
    public function get_personas2() {
        $camp = $this->request->getVar('term');
        $this->ClientesModel = new ClientesModel();
        $citas = $this->ClientesModel->get_personas2($camp);
        //var_export($operaciones);
        return $this->response->setJSON($citas);
    }    
    public function get_pacientes(){        
        ...
        $this->CitasModel = new CitasModel();
        $pacientes = $this->CitasModel->get_personas_citas($parametro);   
        return $this->response->setJSON($pacientes);
    }
    public function get_atenciones(){        
        $codcliente = $this->request->getVar('codcli');
        $this->CitasModel = new CitasModel();
        $pacientes = $this->CitasModel->get_atenciones($codcliente);   
        return $this->response->setJSON($pacientes);
    }
    ...
    public function set_campania(){
        ...
        $this->Caja = new CampaniaModel();
        $data = $this->Caja->crear_campania($data);
        return $data;
    }
    public function save_cita(){
        ...
        $this->Cita = new CitasModel();
        $this->Cita->set_citas($data);
        return true;
    }
    public function editar_cita(){
        ...
        $this->Cita = new CitasModel();
        $this->Cita->upd_cita($this->request->getVar('cit'),$data);
        return true;
    }
    public function confirma_cita(){
        ...
        $data['CIT_ESTADO'] = $est;
        $this->Cita = new CitasModel();
        $desc = $this->Cita->confirma_cita($his,$data);
        return$this->response->setJSON($desc);
    }
    public function eliminar_cita(){
        ...
        $est = $this->request->getVar('est');
        $this->Cita = new CitasModel();
        $desc = $this->Cita->elimina_cita($his,'');
        return$this->response->setJSON($desc);
    }
}